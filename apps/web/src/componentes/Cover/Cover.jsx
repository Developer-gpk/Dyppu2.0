    ...
    return(
        <section className='block' id='cover'>
            <div className='cover-desk'>
                <Parallax>
                    <Image src={CoverDesktop.src} fill priority alt='Diseño de placas flexográficas' quality={100} sizes="100vw" loading='eager' unoptimized />
                </Parallax>
            </div>
            <div className='cover-mobile'>
                <Parallax>
                    <Image src={CoverMobile.src} fill priority alt='Diseño de placas flexográficas' quality={100} sizes="100vw" loading='eager' unoptimized />
                </Parallax>
            </div>
            <div className='holder'>
                <div className='container-fluid' data-aos="fade-right">
                    <h1>Placas flexográficas y fotopolímeros grabados</h1>

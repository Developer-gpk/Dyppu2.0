    ...
    return(
        <section className='block' id='cover'>
            <div className='cover-desk'>
                <Parallax>
                    <Image unoptimized src={CoverDesktop.src} fill priority alt='Diseño de placas flexográficas' quality={100} sizes="100vw" loading='eager' />
                </Parallax>
            </div>
            <div className='cover-mobile'>
                <Parallax>
                    <Image unoptimized src={CoverMobile.src} fill priority alt='Diseño de placas flexográficas' quality={100} sizes="100vw" loading='eager' />
                </Parallax>
            </div>
